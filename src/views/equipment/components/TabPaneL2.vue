<template>
  ...
  <el-table id="tableList" :data="list" cell-style="background: #484bc7;color:#fff;" header-cell-style="background: #484bc7;color:#b2c1de" border fit highlight-current-row style="width: 100%;height:500px;overflow-y: auto;" ref="tablelist">
    <el-table-column
      v-loading="loading"
      align="center"
      label="序号"
