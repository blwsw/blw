<template>
  ...
  <el-button :loading="downloadLoading" v-permission="['admin1','admin2','blw']" style="margin:0 0 20px 20px;" type="primary" icon="el-icon-document" @click="handleDownload1" >
    导出
  </el-button>
  <el-button :loading="downloadLoading" style="margin:0 0 20px 20px;" type="primary" icon="el-icon-document" @click="handlePrint" >
    打印
  </el-button></div>
  <el-table id="tableList" :data="list" cell-style="background: #484bc7;color:#fff;" header-cell-style="background: #484bc7;color:#b2c1de" border fit highlight-current-row style="width: 100%;height:600px;overflow-y: auto;" ref="tablelist">
    <el-table-column
      v-loading="loading"
      align="center"
      label="序号"
